...
def main():
    ...
    if add_selectbox == 'Online':
        ...
        multiplelines = st.selectbox(' Customer has multiplexes:', ['yes', 'no', 'no_phone_service'])
        internetservice = st.selectbox(' Customer has internet service:', ['dsl', 'no', 'fiber_optic'])
        onlinesecurity = st.selectbox(' Customer has insecurity:', ['yes', 'no', 'no_internet_service'])
